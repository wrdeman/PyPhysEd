            ...
            if i==0:
                if self.loop==0:
                    ...
                    self.graph_data=np.append(self.graph_data,
                                              ...
                                              ,0)
        i+=1
        self.plotData(cvImage)

    def plotData(self,cvImage):
...
#opencv axis
        ...
        cv2.line(cvImage,(xx2,int(yy2*0.1)),(xx2,yy2),(255,0,0),1)
        cv2.line(cvImage,(xx2,yy2),(int(xx2+xx2*0.9),yy2),(255,0,0),1)
        ...
        if pts > 1:
            for i in range(pts-1):
                ...
                cv2.line(cvImage,(int(x_cv1),int(y_cv1)),(int(x_cv2),int(y_cv2)),(255,255,0),1)
